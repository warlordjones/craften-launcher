...
import com.craftlauncher.launcher.logic.download.VersionLoader;
...
public class VersionListHelper {
	...
	public boolean isVersionAvailableOnline(String versionName) {
		try {
			String test = DownloadHelper
					.downloadFileToString(DownloadUrls.URL_VERSION + versionName + "/" + versionName + ".json");
