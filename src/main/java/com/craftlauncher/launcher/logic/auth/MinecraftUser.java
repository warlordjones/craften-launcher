...
public class MinecraftUser {
	...
	public boolean equals(Object obj) {
		...
		return this.getEmail().equals(a.getEmail()) && this.getProfileId().equals(a.getProfileId())
				&& this.getUsername().equals(a.getUsername()) && this.getAccessToken().equals(a.getAccessToken())
