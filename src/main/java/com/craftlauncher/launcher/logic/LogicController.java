package com.craftlauncher.launcher.logic;
...
import com.craftlauncher.launcher.exception.CraftenLogicValueIsNullException;
import com.craftlauncher.launcher.exception.CraftenUserException;
import com.craftlauncher.launcher.exception.CraftenVersionNotKnownException;
import com.craftlauncher.launcher.logic.auth.AuthenticationService;
import com.craftlauncher.launcher.logic.auth.MinecraftUser;
import com.craftlauncher.launcher.logic.auth.Profiles;
import com.craftlauncher.launcher.logic.download.DownloadService;
import com.craftlauncher.launcher.logic.download.DownloadTasks;
import com.craftlauncher.launcher.logic.minecraft.MinecraftInfo;
import com.craftlauncher.launcher.logic.minecraft.MinecraftPathImpl;
import com.craftlauncher.launcher.logic.minecraft.MinecraftProcess;
import com.craftlauncher.launcher.logic.version.MinecraftVersion;
import com.craftlauncher.launcher.logic.version.VersionListHelper;
...
public class LogicController {
	...
	public void init(Config config) {
		...
		if(login != null) {
			...
			// user.setAuthentication(showProfile.getUsername(), null, showProfile.getAccessToken(),
			// showProfile.getClientToken(), showProfile.getProfileId(),null);
	...
	public HashMap<String, String> getMinecraftArguments() {
		return new HashMap<>(mMincraftArgs);
	}
