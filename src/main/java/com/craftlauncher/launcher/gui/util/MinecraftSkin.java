package com.craftlauncher.launcher.gui.util;
...
public class MinecraftSkin {
	private static final Rectangle SKIN_HEAD = new Rectangle(8, 8, 8, 8), SKIN_HELMET = new Rectangle(40, 8, 8, 8),
			SKIN_BODY = new Rectangle(20, 20, 8, 12), SKIN_RIGHT_LEG = new Rectangle(4, 20, 4, 12),
			SKIN_LEFT_LEG = new Rectangle(20, 52, 4, 12), SKIN_RIGHT_ARM = new Rectangle(44, 20, 4, 12),
			SKIN_LEFT_ARM = new Rectangle(36, 52, 4, 12), SKIN_BODY_OVERLAY = new Rectangle(20, 36, 8, 12),
			SKIN_RIGHT_LEG_OVERLAY = new Rectangle(4, 36, 4, 12), SKIN_LEFT_LEG_OVERLAY = new Rectangle(4, 52, 4, 12),
			SKIN_RIGHT_ARM_OVERLAY = new Rectangle(44, 36, 4, 12), SKIN_LEFT_ARM_OVERLAY = new Rectangle(52, 52, 4, 12);
